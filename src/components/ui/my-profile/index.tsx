...
import {X, User, Facebook, Mail, Github} from "lucide-react"
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50">
                    ...
                    <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center gap-3">
                            <div
                                ...
                                <img src='/profile/my-profile.jpg' className="w-10 h-10 rounded-full object-cover" alt={"nguyen dinh huy"}/>
                            </div>
                            <div>
            ...
            <button
                ...
                className={`bg-gradient-to-tr  accent-pink-100 w-10 h-10 rounded-full bg-primary text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group ${
